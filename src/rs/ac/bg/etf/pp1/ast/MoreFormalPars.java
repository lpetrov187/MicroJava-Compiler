...
public class MoreFormalPars extends FormalParamList {

    private FormalParamList FormalParamList;
    private FormalParamDecl FormalParamDecl;

    public MoreFormalPars (FormalParamList FormalParamList, FormalParamDecl FormalParamDecl) {
